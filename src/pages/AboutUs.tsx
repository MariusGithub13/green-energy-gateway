            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              <div className="bg-card rounded-lg p-6 shadow-sm border border-border text-center">
                ...
                <p className="text-sm text-muted-foreground">
                  ...
                  Founder of <a target="_blank" rel="noopener" href="https://www.devaland.com/">Devaland Automation Agency</a> and <a target="_blank" rel="noopener" href="https://klavipro.com/">KlaviPro, Klaviyo Agency Partner</a>
                </p>
              </div>
              <div className="bg-card rounded-lg p-6 shadow-sm border border-border text-center">
                <div className="w-24 h-24 rounded-full bg-muted mx-auto mb-4"></div>
